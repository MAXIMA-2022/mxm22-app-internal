                ...
                <Box w={"full"} bgColor={"white"} borderRadius={20} mb={4}>
                    ...
                    <Box py={4} mx={4}>
                        {dataMhs.map((data: DataMHS) => (
                            ...
                            >
                                <Box width={"100%"} px={2}>
                                    <FormLabel textColor={"black"}>Nama Mahasiswa</FormLabel>
                                    <Input
                                        value={data.name}
                                        border={"solid"}
                                        borderColor={"#CBD5E0"}
                                ...
                                <Box width={"100%"} px={2} mt={[2]}>
                                    <FormLabel textColor={"black"}>Nomor Induk Mahasiswa</FormLabel>
                                    <Input
                                        value={data.nim}
                                        border={"solid"}
                                        borderColor={"#CBD5E0"}
                                ...
                                <Box width={"100%"} px={2} mt={[2]}>
                                    <FormLabel textColor={"black"}>Nomor Hp</FormLabel>
                                    <Input
                                        value={data.whatsapp}
                                        border={"solid"}
                                        borderColor={"#CBD5E0"}
                                ...
                                <Box width={"100%"} px={2} mt={[2]}>
                                    <FormLabel textColor={"black"}>Instagram</FormLabel>
                                    <Input
                                ...
                                <Box width={"100%"} px={2} mt={[2]}>
                                    <FormLabel textColor={"black"}>Line</FormLabel>
                                    <Input
                                        value={data.idLine}
                                        border={"solid"}
                                        borderColor={"#CBD5E0"}
                                ...
                                <Box width={"100%"} px={2} mt={[2]}>
                                    <FormLabel textColor={"black"}>Jenis Kelamin</FormLabel>
                                    <Input
                                ...
                                <Box width={"100%"} px={2} mt={[2]}>
                                    <FormLabel textColor={"black"}>Tanggal Lahir</FormLabel>
                                    <Input
                                ...
                                <Box width={"100%"} px={2} mt={[2]}>
                                    <FormLabel textColor={"black"}>Prodi</FormLabel>
                                    <Input
                                        value={data.prodi}
                                        border={"solid"}
                                        borderColor={"#CBD5E0"}
